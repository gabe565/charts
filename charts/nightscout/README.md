...
![AppVersion: 15.0.3](https://img.shields.io/badge/AppVersion-15.0.3-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=nightscout&version=0.13.1)**
...
| image.tag | string | `"15.0.3"` | image tag |
