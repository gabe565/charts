...
![AppVersion: 0.15.2](https://img.shields.io/badge/AppVersion-0.15.2-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=memos&version=0.7.2)**
...
| image.tag | string | `"0.15.2"` | image tag |
