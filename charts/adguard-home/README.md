...
![AppVersion: v0.107.37](https://img.shields.io/badge/AppVersion-v0.107.37-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=adguard-home&version=0.3.9)**
...
| image.tag | string | `"v0.107.37"` | Image tag |
