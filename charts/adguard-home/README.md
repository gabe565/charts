...
![AppVersion: v0.107.39](https://img.shields.io/badge/AppVersion-v0.107.39-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=adguard-home&version=0.3.12)**
...
| image.tag | string | `"v0.107.39"` | Image tag |
