...
![AppVersion: v0.107.33](https://img.shields.io/badge/AppVersion-v0.107.33-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=adguard-home&version=0.3.4)**
...
| image.tag | string | `"v0.107.33"` | Image tag |
