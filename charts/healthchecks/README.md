...
![AppVersion: version-v3.8.2](https://img.shields.io/badge/AppVersion-version--v3.8.2-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=healthchecks&version=0.16.1)**
...
| image.tag | string | `"version-v3.8.2"` | Image tag |
