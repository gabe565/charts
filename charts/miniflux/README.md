...
![AppVersion: 2.2.10](https://img.shields.io/badge/AppVersion-2.2.10-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=miniflux&version=0.9.3)**
...
| image.tag | string | `"2.2.10"` | image tag |
