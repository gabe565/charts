...
![AppVersion: release-v3.0.2](https://img.shields.io/badge/AppVersion-release--v3.0.2-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=scanservjs&version=0.9.1)**
...
| image.tag | string | `"release-v3.0.2"` | image tag |
