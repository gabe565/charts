...
![AppVersion: 2023.6.5](https://img.shields.io/badge/AppVersion-2023.6.5-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=esphome&version=0.6.6)**
...
| image.tag | string | `"2023.6.5"` | image tag |
