...
![AppVersion: 2023.11.6](https://img.shields.io/badge/AppVersion-2023.11.6-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=esphome&version=0.11.3)**
...
| image.tag | string | `"2023.11.6"` | image tag |
