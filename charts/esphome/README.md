...
![AppVersion: 2023.11.4](https://img.shields.io/badge/AppVersion-2023.11.4-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=esphome&version=0.11.2)**
...
| image.tag | string | `"2023.11.4"` | image tag |
