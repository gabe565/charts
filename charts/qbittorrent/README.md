...
![AppVersion: version-5.1.2-r1](https://img.shields.io/badge/AppVersion-version--5.1.2--r1-informational?style=flat)
...
| image.tag | string | `"version-5.1.2-r1"` | image tag |
