...
![AppVersion: version-4.6.5-r0](https://img.shields.io/badge/AppVersion-version--4.6.5--r0-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=qbittorrent&version=0.3.6)**
...
| image.tag | string | `"version-4.6.5-r0"` | image tag |
