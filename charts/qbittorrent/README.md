...
![AppVersion: version-5.1.1-r0](https://img.shields.io/badge/AppVersion-version--5.1.1--r0-informational?style=flat)
...
| image.tag | string | `"version-5.1.1-r0"` | image tag |
