...
![AppVersion: version-4.5.4-r1](https://img.shields.io/badge/AppVersion-version--4.5.4--r1-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=qbittorrent&version=0.2.3)**
...
| image.tag | string | `"version-4.5.4-r1"` | image tag |
