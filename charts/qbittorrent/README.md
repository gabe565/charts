...
![AppVersion: version-5.1.4-r2](https://img.shields.io/badge/AppVersion-version--5.1.4--r2-informational?style=flat)
...
| image.tag | string | `"version-5.1.4-r2"` | image tag |
