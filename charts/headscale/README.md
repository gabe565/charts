...
| configMaps.extraDnsRecords.data.records | string | `nil` | Extra DNS records JSON [[ref]](https://headscale.net/development/ref/dns/#__tabbed_1_2)                                                                                                                        |
| configMaps.extraDnsRecords.enabled                  | bool | `false` | Enables extra DNS records from configMap (json format)                                                                                                                                     |
