...
![AppVersion: 1.4.10](https://img.shields.io/badge/AppVersion-1.4.10-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=tandoor&version=0.7.1)**
...
| image.tag | string | `"1.4.10"` | image tag |
