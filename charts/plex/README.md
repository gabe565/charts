...
![AppVersion: version-1.41.7.9799-5bce000f7](https://img.shields.io/badge/AppVersion-version--1.41.7.9799--5bce000f7-informational?style=flat)
...
| image.tag | string | `"version-1.41.7.9799-5bce000f7"` | image tag |
