...
![AppVersion: version-1.40.4.8679-424562606](https://img.shields.io/badge/AppVersion-version--1.40.4.8679--424562606-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=plex&version=0.4.3)**
...
| image.tag | string | `"version-1.40.4.8679-424562606"` | image tag |
