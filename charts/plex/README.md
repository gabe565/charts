...
![AppVersion: version-1.32.5.7328-2632c9d3a](https://img.shields.io/badge/AppVersion-version--1.32.5.7328--2632c9d3a-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=plex&version=0.3.6)**
...
| image.tag | string | `"version-1.32.5.7328-2632c9d3a"` | image tag |
