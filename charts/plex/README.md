...
![AppVersion: version-1.32.0.6973-a787c5a8e](https://img.shields.io/badge/AppVersion-version--1.32.0.6973--a787c5a8e-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=plex&version=0.2.2)**
...
| image.tag | string | `"version-1.32.0.6973-a787c5a8e"` | image tag |
