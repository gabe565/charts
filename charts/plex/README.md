...
![AppVersion: version-1.32.3.7162-b0a36929b](https://img.shields.io/badge/AppVersion-version--1.32.3.7162--b0a36929b-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=plex&version=0.3.3)**
...
| image.tag | string | `"version-1.32.3.7162-b0a36929b"` | image tag |
