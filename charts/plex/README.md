...
![AppVersion: version-1.32.0.6918-6f393eda1](https://img.shields.io/badge/AppVersion-version--1.32.0.6918--6f393eda1-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=plex&version=0.2.0)**
...
| image.tag | string | `"version-1.32.0.6918-6f393eda1"` | image tag |
