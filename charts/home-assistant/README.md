...
![AppVersion: 2024.2.5](https://img.shields.io/badge/AppVersion-2024.2.5-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=home-assistant&version=0.14.1)**
...
| image.tag | string | `"2024.2.5"` | image tag |
