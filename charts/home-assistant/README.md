...
![AppVersion: 2023.12.3](https://img.shields.io/badge/AppVersion-2023.12.3-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=home-assistant&version=0.12.1)**
...
| image.tag | string | `"2023.12.3"` | image tag |
