...
![AppVersion: 2024.1.3](https://img.shields.io/badge/AppVersion-2024.1.3-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=home-assistant&version=0.13.2)**
...
| image.tag | string | `"2024.1.3"` | image tag |
