...
![AppVersion: 1.30.0-alpine](https://img.shields.io/badge/AppVersion-1.30.0--alpine-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=vaultwarden&version=0.11.0)**
...
| image.tag | string | `"1.30.0-alpine"` | image tag |
