...
![Version: 0.11.10](https://img.shields.io/badge/Version-0.11.10-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: 0.45.8.1](https://img.shields.io/badge/AppVersion-0.45.8.1-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=changedetection-io&version=0.11.10)**
...
| image.tag | string | `"0.45.8.1"` | image tag |
