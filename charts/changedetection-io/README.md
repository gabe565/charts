...
![AppVersion: 0.44](https://img.shields.io/badge/AppVersion-0.44-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=changedetection-io&version=0.10.1)**
...
| image.tag | float | `0.44` | image tag |
