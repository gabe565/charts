...
![AppVersion: 0.42.3](https://img.shields.io/badge/AppVersion-0.42.3-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=changedetection-io&version=0.8.2)**
...
| image.tag | string | `"0.42.3"` | image tag |
