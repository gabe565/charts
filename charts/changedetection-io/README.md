...
![AppVersion: 0.45.4](https://img.shields.io/badge/AppVersion-0.45.4-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=changedetection-io&version=0.11.5)**
...
| image.tag | string | `"0.45.4"` | image tag |
