...
![Version: 0.11.16](https://img.shields.io/badge/Version-0.11.16-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: 0.45.17](https://img.shields.io/badge/AppVersion-0.45.17-informational?style=flat)
...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=changedetection-io&version=0.11.16)**
...
| image.tag | string | `"0.45.17"` | image tag |
